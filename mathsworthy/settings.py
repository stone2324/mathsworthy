"""
Django settings for mathsworthy project.
...
SECRET_KEY = 'django-insecure-mzy3=oln@26@n(qrqei2!sau6$md5&+9%gs5hu**2hp9%*j73*'
...
WSGI_APPLICATION = 'mathsworthy.wsgi.application'
